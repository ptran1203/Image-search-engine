...
import Duy from "../src/pages/Duy.jsx"
...
var dashRoutes = [
  ...
  {
    collapse: true, //dùng để collapse
    path: "-page",
    name: "Pages",
    state: "openPages",
    icon: Image,
    views: pages  //có thể truyền vào biến object như ví dụ này hoặc truyền thẳng array object vào
  },
  {
    collapse: true,
    path: "/components",
